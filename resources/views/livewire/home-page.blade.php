            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1 class="block text-3xl font-bold text-gray-800 sm:text-4xl lg:text-6xl lg:leading-tight dark:text-white">
                        {{__('home.title')}}<span class="text-blue-600">{{ config('app.name', 'Laravel') }}</span>
                    </h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">{{__('home.description')}}</p>
            ...
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200">
                        {{__('home.brands_section.browse_popular')}}<span class="text-blue-500">{{__('home.brands_section.brands')}}</span>
                    </h1>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    {{__('home.brands_section.description')}}
                </p>
            </div>
        </div>
    ...
    <section class="bg-orange-200 py-20">
        <div class="max-w-xl mx-auto">
            <div class="text-center ">
                <div class="relative flex flex-col items-center">
                    <h1 class="text-5xl font-bold dark:text-gray-200">
                        {{__('home.categories_section.browse_popular')}} <span class="text-blue-500">{{__('home.categories_section.categories')}}</span>
                    </h1>
                    <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                        <div class="flex-1 h-2 bg-blue-200">
                        </div>
                ...
                <p class="mb-12 text-base text-center text-gray-500">
                    {{__('home.categories_section.description')}}
                </p>
            </div>
        </div>
        ...
        <div class="max-w-6xl px-4 py-6 mx-auto lg:py-4 md:px-6">
            <div class="max-w-xl mx-auto">
                <div class="text-center ">
                    <div class="relative flex flex-col items-center">
                        <h1 class="text-5xl font-bold dark:text-gray-200">
                            {{__('home.customer_reviews_section.customer')}} <span class="text-blue-500"> {{__('home.customer_reviews_section.reviews')}}</span>
                        </h1>
                        <div class="flex w-40 mt-2 mb-6 overflow-hidden rounded">
                            <div class="flex-1 h-2 bg-blue-200">
                            </div>
                    ...
                    <p class="mb-12 text-base text-center text-gray-500">
                        {{__('home.customer_reviews_section.description')}}
                    </p>
                </div>
            </div>
